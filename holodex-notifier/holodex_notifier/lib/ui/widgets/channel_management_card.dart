  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            FilterChip(
              ...
              onSelected:
                  (v) =>
                      ref.read(globalNewMediaDefaultProvider.notifier).state =
                          v,
            ),
            FilterChip(
              ...
              onSelected:
                  (v) =>
                      ref.read(globalMentionsDefaultProvider.notifier).state =
                          v,
            ),
            FilterChip(
              ...
              selected: globalLive,
              onSelected:
                  (v) => ref.read(globalLiveDefaultProvider.notifier).state = v,
            ),
            FilterChip(
              ...
              onSelected:
                  (v) =>
                      ref.read(globalUpdateDefaultProvider.notifier).state = v,
            ),
          ],
        ),
        Center(
          child: ElevatedButton.icon(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Notification defaults applied to all channels'),
            ...
            return SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final bool alreadyAdded = channelList.any(
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      channel.englishName ?? channel.id,
                        ...
                        alreadyAdded
                            ...
                            : IconButton(
                              ...
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text('Added ${channel.name}'),
                                    duration: Duration(seconds: 2),
                                  ),
                                );
        ...
        const Divider(height: 24.0),
        Text(
          'Added Channels (${channelList.length})',
        ...
        if (channelList.isEmpty)
          const Center(
            child: Padding(
              ...
              child: Text('No channels added yet. Use the search bar above to add channels.'),
            ),
          )
        else
