...
mixin _$ChannelMin {
  ...
  String? get englishName =>
      throw _privateConstructorUsedError; // TODO: Consider using an enum for type
  String get type =>
      throw _privateConstructorUsedError; // Default based on typical usage, API says enum: ['vtuber', 'subber']
...
abstract class _$$ChannelMinImplCopyWith<$Res>
  ...
  factory _$$ChannelMinImplCopyWith(
    _$ChannelMinImpl value,
    $Res Function(_$ChannelMinImpl) then,
...
class __$$ChannelMinImplCopyWithImpl<$Res>
  ...
  __$$ChannelMinImplCopyWithImpl(
    _$ChannelMinImpl _value,
    $Res Function(_$ChannelMinImpl) _then,
  ) : super(_value, _then);
...
class _$ChannelMinImpl implements _ChannelMin {
  ...
  @JsonKey()
  final String type;
  // Default based on typical usage, API says enum: ['vtuber', 'subber']
  @override
  final String? photo;
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, englishName, type, photo);
...
abstract class _ChannelMin implements ChannelMin {
  ...
  String get name;
  @override
  String? get englishName; // TODO: Consider using an enum for type
  @override
  String get type; // Default based on typical usage, API says enum: ['vtuber', 'subber']
  @override
  String? get photo;
