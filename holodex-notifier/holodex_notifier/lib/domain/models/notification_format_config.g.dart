...
_$NotificationFormatImpl _$$NotificationFormatImplFromJson(Map<String, dynamic> json) => _$NotificationFormatImpl(
...
Map<String, dynamic> _$$NotificationFormatImplToJson(_$NotificationFormatImpl instance) => <String, dynamic>{
...
_$NotificationFormatConfigImpl _$$NotificationFormatConfigImplFromJson(Map<String, dynamic> json) => _$NotificationFormatConfigImpl(
  formats: _notificationFormatMapFromJson(json['formats'] as Map<String, dynamic>),
  version: (json['version'] as num?)?.toInt() ?? 1,
);

Map<String, dynamic> _$$NotificationFormatConfigImplToJson(_$NotificationFormatConfigImpl instance) => <String, dynamic>{
