...
_VideoWithChannel _$VideoWithChannelFromJson(Map<String, dynamic> json) => _VideoWithChannel(
  id: json['id'] as String,
  title: json['title'] as String,
  type: json['type'] as String,
  topicId: json['topic_id'] as String?,
...
Map<String, dynamic> _$VideoWithChannelToJson(_VideoWithChannel instance) => <String, dynamic>{
  'id': instance.id,
  'title': instance.title,
  'type': instance.type,
  'topic_id': instance.topicId,
