...
_$VideoFullImpl _$$VideoFullImplFromJson(Map<String, dynamic> json) => _$VideoFullImpl(
...
Map<String, dynamic> _$$VideoFullImplToJson(_$VideoFullImpl instance) => <String, dynamic>{
  'id': instance.id,
