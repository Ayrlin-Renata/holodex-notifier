...
class $CachedVideosTable extends CachedVideos with TableInfo<$CachedVideosTable, CachedVideo> {
  ...
  @override
  late final GeneratedColumnWithTypeConverter<List<String>, String> sentMentionTargetIds = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    defaultValue: const Constant('[]'),
  ).withConverter<List<String>>($CachedVideosTable.$convertersentMentionTargetIds);
  @override
  ...
  CachedVideo map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CachedVideo(
      ...
      sentMentionTargetIds: $CachedVideosTable.$convertersentMentionTargetIds.fromSql(
        attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}sent_mention_target_ids'])!,
      ),
    );
  }
  ...
  static TypeConverter<List<String>, String> $convertersentMentionTargetIds = const StringListConverter();
}
...
class CachedVideo extends DataClass implements Insertable<CachedVideo> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['sent_mention_target_ids'] = Variable<String>($CachedVideosTable.$convertersentMentionTargetIds.toSql(sentMentionTargetIds));
    }
    return map;
  }
  ...
  factory CachedVideo.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    ...
    return CachedVideo(
      ...
      sentMentionTargetIds: serializer.fromJson<List<String>>(json['sentMentionTargetIds']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'sentMentionTargetIds': serializer.toJson<List<String>>(sentMentionTargetIds),
    };
  }
  ...
  CachedVideo copyWithCompanion(CachedVideosCompanion data) {
    return CachedVideo(
      ...
      sentMentionTargetIds: data.sentMentionTargetIds.present ? data.sentMentionTargetIds.value : this.sentMentionTargetIds,
    );
  }
...
class CachedVideosCompanion extends UpdateCompanion<CachedVideo> {
  ...
  static Insertable<CachedVideo> custom({
    ...
    return RawValuesInsertable({
      ...
      if (sentMentionTargetIds != null) 'sent_mention_target_ids': sentMentionTargetIds,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sentMentionTargetIds.present) {
      map['sent_mention_target_ids'] = Variable<String>($CachedVideosTable.$convertersentMentionTargetIds.toSql(sentMentionTargetIds.value));
    }
    if (rowid.present) {
...
class $ChannelNameCacheTable extends ChannelNameCache with TableInfo<$ChannelNameCacheTable, ChannelNameCacheEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<ChannelNameCacheEntry> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('channel_id')) {
      context.handle(_channelIdMeta, channelId.isAcceptableOrUnknown(data['channel_id']!, _channelIdMeta));
  ...
  ChannelNameCacheEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChannelNameCacheEntry(
      channelId: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}channel_id'])!,
      channelName: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}channel_name'])!,
      lastUpdated: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}last_updated'])!,
    );
  }
...
class ChannelNameCacheEntry extends DataClass implements Insertable<ChannelNameCacheEntry> {
  final String channelId;
  final String channelName;
  final int lastUpdated;
  const ChannelNameCacheEntry({required this.channelId, required this.channelName, required this.lastUpdated});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['channel_id'] = Variable<String>(channelId);
  ...
  ChannelNameCacheCompanion toCompanion(bool nullToAbsent) {
    return ChannelNameCacheCompanion(channelId: Value(channelId), channelName: Value(channelName), lastUpdated: Value(lastUpdated));
  }

  factory ChannelNameCacheEntry.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ChannelNameCacheEntry(
      channelId: serializer.fromJson<String>(json['channelId']),
      channelName: serializer.fromJson<String>(json['channelName']),
  ...
  ChannelNameCacheEntry copyWith({String? channelId, String? channelName, int? lastUpdated}) => ChannelNameCacheEntry(
    channelId: channelId ?? this.channelId,
    channelName: channelName ?? this.channelName,
...
class ChannelNameCacheCompanion extends UpdateCompanion<ChannelNameCacheEntry> {
  ...
  ChannelNameCacheCompanion copyWith({Value<String>? channelId, Value<String>? channelName, Value<int>? lastUpdated, Value<int>? rowid}) {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ChannelNameCacheTable channelNameCache = $ChannelNameCacheTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables => allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [cachedVideos, channelNameCache];
}
...
class $$CachedVideosTableFilterComposer extends Composer<_$AppDatabase, $CachedVideosTable> {
  ...
  ColumnFilters<String> get videoId => $composableBuilder(column: $table.videoId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get channelId => $composableBuilder(column: $table.channelId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get topicId => $composableBuilder(column: $table.topicId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get status => $composableBuilder(column: $table.status, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get startScheduled => $composableBuilder(column: $table.startScheduled, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get startActual => $composableBuilder(column: $table.startActual, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get availableAt => $composableBuilder(column: $table.availableAt, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get videoType => $composableBuilder(column: $table.videoType, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get thumbnailUrl => $composableBuilder(column: $table.thumbnailUrl, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get certainty => $composableBuilder(column: $table.certainty, builder: (column) => ColumnFilters(column));

  ColumnWithTypeConverterFilters<List<String>, List<String>, String> get mentionedChannelIds =>
      $composableBuilder(column: $table.mentionedChannelIds, builder: (column) => ColumnWithTypeConverterFilters(column));

  ColumnFilters<String> get videoTitle => $composableBuilder(column: $table.videoTitle, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get channelName => $composableBuilder(column: $table.channelName, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get channelAvatarUrl => $composableBuilder(column: $table.channelAvatarUrl, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get isPendingNewMediaNotification =>
      $composableBuilder(column: $table.isPendingNewMediaNotification, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get lastSeenTimestamp => $composableBuilder(column: $table.lastSeenTimestamp, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get scheduledLiveNotificationId =>
      $composableBuilder(column: $table.scheduledLiveNotificationId, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get lastLiveNotificationSentTime =>
      $composableBuilder(column: $table.lastLiveNotificationSentTime, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get scheduledReminderNotificationId =>
      $composableBuilder(column: $table.scheduledReminderNotificationId, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get scheduledReminderTime =>
      $composableBuilder(column: $table.scheduledReminderTime, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get userDismissedAt => $composableBuilder(column: $table.userDismissedAt, builder: (column) => ColumnFilters(column));

  ColumnWithTypeConverterFilters<List<String>, List<String>, String> get sentMentionTargetIds =>
      $composableBuilder(column: $table.sentMentionTargetIds, builder: (column) => ColumnWithTypeConverterFilters(column));
}

class $$CachedVideosTableOrderingComposer extends Composer<_$AppDatabase, $CachedVideosTable> {
  ...
  ColumnOrderings<String> get videoId => $composableBuilder(column: $table.videoId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get channelId => $composableBuilder(column: $table.channelId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get topicId => $composableBuilder(column: $table.topicId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get status => $composableBuilder(column: $table.status, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get startScheduled => $composableBuilder(column: $table.startScheduled, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get startActual => $composableBuilder(column: $table.startActual, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get availableAt => $composableBuilder(column: $table.availableAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get videoType => $composableBuilder(column: $table.videoType, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get thumbnailUrl => $composableBuilder(column: $table.thumbnailUrl, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get certainty => $composableBuilder(column: $table.certainty, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get mentionedChannelIds =>
      $composableBuilder(column: $table.mentionedChannelIds, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get videoTitle => $composableBuilder(column: $table.videoTitle, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get channelName => $composableBuilder(column: $table.channelName, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get channelAvatarUrl => $composableBuilder(column: $table.channelAvatarUrl, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get isPendingNewMediaNotification =>
      $composableBuilder(column: $table.isPendingNewMediaNotification, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get lastSeenTimestamp => $composableBuilder(column: $table.lastSeenTimestamp, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get scheduledLiveNotificationId =>
      $composableBuilder(column: $table.scheduledLiveNotificationId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get lastLiveNotificationSentTime =>
      $composableBuilder(column: $table.lastLiveNotificationSentTime, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get scheduledReminderNotificationId =>
      $composableBuilder(column: $table.scheduledReminderNotificationId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get scheduledReminderTime =>
      $composableBuilder(column: $table.scheduledReminderTime, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get userDismissedAt => $composableBuilder(column: $table.userDismissedAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get sentMentionTargetIds =>
      $composableBuilder(column: $table.sentMentionTargetIds, builder: (column) => ColumnOrderings(column));
}

class $$CachedVideosTableAnnotationComposer extends Composer<_$AppDatabase, $CachedVideosTable> {
  ...
  GeneratedColumn<String> get topicId => $composableBuilder(column: $table.topicId, builder: (column) => column);

  GeneratedColumn<String> get status => $composableBuilder(column: $table.status, builder: (column) => column);

  GeneratedColumn<String> get startScheduled => $composableBuilder(column: $table.startScheduled, builder: (column) => column);

  GeneratedColumn<String> get startActual => $composableBuilder(column: $table.startActual, builder: (column) => column);

  GeneratedColumn<String> get availableAt => $composableBuilder(column: $table.availableAt, builder: (column) => column);

  GeneratedColumn<String> get videoType => $composableBuilder(column: $table.videoType, builder: (column) => column);

  GeneratedColumn<String> get thumbnailUrl => $composableBuilder(column: $table.thumbnailUrl, builder: (column) => column);

  GeneratedColumn<String> get certainty => $composableBuilder(column: $table.certainty, builder: (column) => column);

  GeneratedColumnWithTypeConverter<List<String>, String> get mentionedChannelIds =>
      $composableBuilder(column: $table.mentionedChannelIds, builder: (column) => column);

  GeneratedColumn<String> get videoTitle => $composableBuilder(column: $table.videoTitle, builder: (column) => column);

  GeneratedColumn<String> get channelName => $composableBuilder(column: $table.channelName, builder: (column) => column);

  GeneratedColumn<String> get channelAvatarUrl => $composableBuilder(column: $table.channelAvatarUrl, builder: (column) => column);

  GeneratedColumn<bool> get isPendingNewMediaNotification =>
      $composableBuilder(column: $table.isPendingNewMediaNotification, builder: (column) => column);

  GeneratedColumn<int> get lastSeenTimestamp => $composableBuilder(column: $table.lastSeenTimestamp, builder: (column) => column);

  GeneratedColumn<int> get scheduledLiveNotificationId => $composableBuilder(column: $table.scheduledLiveNotificationId, builder: (column) => column);

  GeneratedColumn<int> get lastLiveNotificationSentTime =>
      $composableBuilder(column: $table.lastLiveNotificationSentTime, builder: (column) => column);

  GeneratedColumn<int> get scheduledReminderNotificationId =>
      $composableBuilder(column: $table.scheduledReminderNotificationId, builder: (column) => column);

  GeneratedColumn<int> get scheduledReminderTime => $composableBuilder(column: $table.scheduledReminderTime, builder: (column) => column);

  GeneratedColumn<int> get userDismissedAt => $composableBuilder(column: $table.userDismissedAt, builder: (column) => column);

  GeneratedColumnWithTypeConverter<List<String>, String> get sentMentionTargetIds =>
      $composableBuilder(column: $table.sentMentionTargetIds, builder: (column) => column);
}
...
class $$CachedVideosTableTableManager
    extends
        RootTableManager<
          ...
          (CachedVideo, BaseReferences<_$AppDatabase, $CachedVideosTable, CachedVideo>),
          CachedVideo,
  ...
  $$CachedVideosTableTableManager(_$AppDatabase db, $CachedVideosTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$CachedVideosTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$CachedVideosTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$CachedVideosTableAnnotationComposer($db: db, $table: table),
...
typedef $$ChannelNameCacheTableCreateCompanionBuilder =
    ChannelNameCacheCompanion Function({required String channelId, required String channelName, required int lastUpdated, Value<int> rowid});
typedef $$ChannelNameCacheTableUpdateCompanionBuilder =
    ChannelNameCacheCompanion Function({Value<String> channelId, Value<String> channelName, Value<int> lastUpdated, Value<int> rowid});

class $$ChannelNameCacheTableFilterComposer extends Composer<_$AppDatabase, $ChannelNameCacheTable> {
  ...
  ColumnFilters<int> get lastUpdated => $composableBuilder(column: $table.lastUpdated, builder: (column) => ColumnFilters(column));
}

class $$ChannelNameCacheTableOrderingComposer extends Composer<_$AppDatabase, $ChannelNameCacheTable> {
  ...
  ColumnOrderings<int> get lastUpdated => $composableBuilder(column: $table.lastUpdated, builder: (column) => ColumnOrderings(column));
}

class $$ChannelNameCacheTableAnnotationComposer extends Composer<_$AppDatabase, $ChannelNameCacheTable> {
  ...
  GeneratedColumn<int> get lastUpdated => $composableBuilder(column: $table.lastUpdated, builder: (column) => column);
}
...
class $$ChannelNameCacheTableTableManager
    extends
        RootTableManager<
          ...
          (ChannelNameCacheEntry, BaseReferences<_$AppDatabase, $ChannelNameCacheTable, ChannelNameCacheEntry>),
          ChannelNameCacheEntry,
          PrefetchHooks Function()
        > {
  $$ChannelNameCacheTableTableManager(_$AppDatabase db, $ChannelNameCacheTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$ChannelNameCacheTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$ChannelNameCacheTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$ChannelNameCacheTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> channelId = const Value.absent(),
                Value<String> channelName = const Value.absent(),
                ...
                Value<int> rowid = const Value.absent(),
              }) => ChannelNameCacheCompanion(channelId: channelId, channelName: channelName, lastUpdated: lastUpdated, rowid: rowid),
          createCompanionCallback:
              ({required String channelId, required String channelName, required int lastUpdated, Value<int> rowid = const Value.absent()}) =>
                  ChannelNameCacheCompanion.insert(channelId: channelId, channelName: channelName, lastUpdated: lastUpdated, rowid: rowid),
          withReferenceMapper: (p0) => p0.map((e) => (e.readTable(table), BaseReferences(db, table, e))).toList(),
          prefetchHooksCallback: null,
        ),
      );
...
class $AppDatabaseManager {
  ...
  $$ChannelNameCacheTableTableManager get channelNameCache => $$ChannelNameCacheTableTableManager(_db, _db.channelNameCache);
}
