...
_NotificationFormat _$NotificationFormatFromJson(Map<String, dynamic> json) => _NotificationFormat(
...
Map<String, dynamic> _$NotificationFormatToJson(_NotificationFormat instance) => <String, dynamic>{
...
_NotificationFormatConfig _$NotificationFormatConfigFromJson(Map<String, dynamic> json) => _NotificationFormatConfig(
  formats: _notificationFormatMapFromJson(json['formats'] as Map<String, dynamic>),
  version: (json['version'] as num?)?.toInt() ?? 1,
);

Map<String, dynamic> _$NotificationFormatConfigToJson(_NotificationFormatConfig instance) => <String, dynamic>{
